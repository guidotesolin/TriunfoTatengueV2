const getPrensa = () => {
  const prensa = [
    ...
    {
      id: 17,
      title: "Parte de prensa conjunto: Consenso para la reforma del Estatuto",
    ...
    {
      id: 20,
      title: `Villarreal, tajante: "Es un nuevo hecho delictivo de Spahn"`,
      epigraph:
        "Más repercusiones por las declaraciones del presidente de Unión",
      text: [
